...
function App() {
  ...
  const homeWeb = (
    <div>
      ...
      <header className="u-black u-clearfix u-header u-header" id="sec-6e9a">
        <div className="u-clearfix u-sheet u-sheet-1">
          ...
          <form
            action="#"
            method="get"
            className="u-border-1 u-border-grey-30 u-radius-50 u-search u-search-left u-white u-search-1"
          >
          ...
          <img
            className="u-image u-image-round u-radius-29 u-image-1"
          ...
          />
          <img
            className="u-border-5 u-border-white u-image u-image-circle u-preserve-proportions u-image-2"
          ...
          <div className="u-align-left u-border-2 u-border-palette-1-base u-container-style u-group u-radius-50 u-shape-round u-group-1">
            <div className="u-container-layout u-container-layout-1">
              ...
              <a className="u-border-none u-btn u-btn-round u-button-style u-hover-palette-1-light-1 u-palette-2-base u-radius-50 u-btn-1">
                {" "}
                @Amatur destroy @Alama Kingdom
              </a>
              <a className="u-btn u-btn-round u-button-style u-hover-palette-1-light-1 u-palette-1-base u-radius-50 u-btn-2">
                &nbsp; &nbsp; &nbsp; &nbsp;​@Penguin Upgrade Town to lv 30&nbsp;
                &nbsp; &nbsp; &nbsp;&nbsp;
              </a>
              <a className="u-border-none u-btn u-btn-round u-button-style u-custom-color-2 u-hover-palette-4-light-2 u-radius-50 u-btn-3">
                {" "}
                @WinterKingdom just harvest 300,000 FDH
              </a>
            </div>
          </div>
  ...
  c2.7-0.3,5.3-1,7.7-2.1C88.7,43,86.4,45.4,83.8,47.3z"
            ...
            <a className="u-social-url" title="instagram" target="_blank">
  ...
  c5.5,0,9.9,4.5,9.9,9.9V73.3z"
          ...
          <p className="u-text u-text-default u-text-white u-text-3">
            RULER : HAPPY STARLORD
          </p>
          ...
          <p className="u-text u-text-body-alt-color u-text-default u-text-5">
            BIO : PENGUIN KINGDOM IN SPACE&nbsp;
          </p>
          <p className="u-text u-text-body-alt-color u-text-default u-text-6">
            Current Blanace : 300987 FDH
          </p>
        </div>
      </header>
      <section
        className="u-align-center u-black u-clearfix u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-section-1"
        id="carousel_8701"
      >
        <div className="u-align-left u-clearfix u-sheet u-sheet-1">
          <div className="u-expanded-width u-tab-links-align-justify u-tabs u-tabs-1">
            <ul
              className="u-black u-spacing-10 u-tab-list u-unstyled u-tab-list-1"
              role="tablist"
            >
              <li className="u-tab-item u-tab-item-1" role="presentation">
                <a
                  className="active u-border-2 u-border-black u-button-style u-radius-50 u-tab-link u-text-active-black u-text-black u-white u-tab-link-1"
                  id="link-tab-14b7"
                  href="#tab-14b7"
                  role="tab"
              ...
              <li className="u-tab-item u-tab-item-2" role="presentation">
                <a
                  className="u-border-2 u-border-black u-button-style u-radius-50 u-tab-link u-text-active-black u-text-black u-white u-tab-link-2"
                  id="link-tab-0da5"
                  href="#tab-0da5"
                  role="tab"
              ...
              <li className="u-tab-item" role="presentation">
                <a
                  className="u-border-2 u-border-black u-button-style u-radius-50 u-tab-link u-text-active-black u-text-black u-white u-tab-link-3"
                  id="link-tab-2917"
                  href="#tab-2917"
                  role="tab"
              ...
              <li className="u-tab-item u-tab-item-4" role="presentation">
                <a
                  className="u-border-2 u-border-black u-button-style u-radius-50 u-tab-link u-text-active-black u-text-black u-white u-tab-link-4"
                  id="tab-6e5a"
                  href="#link-tab-6e5a"
                  role="tab"
            ...
            <div className="u-tab-content">
              <div
                className="u-align-left u-black u-container-style u-tab-active u-tab-pane u-tab-pane-1"
                id="tab-14b7"
                role="tabpanel"
                ...
                <div className="u-container-layout u-container-layout-1">
                  ...
                  <h5 className="u-text u-text-default u-text-2">
                    <span style={{ fontWeight: 700 }}>
                      Town Center - Level 28
                    </span>
                    <span style={{ fontWeight: 700 }} />
                  </h5>
                  <img
                    className="u-border-7 u-border-white u-image u-image-circle u-image-1"
                    src="images/Kingdom-Transparent-PNG.png"
                    alt=""
                    data-image-width={600}
                    data-image-height={521}
                  />
                  <a
                    onClick={() => console.log("click claim")}
                    className="u-border-2 u-border-hover-palette-1-base u-border-palette-1-base u-btn u-btn-round u-button-style u-hover-palette-1-base u-none u-radius-50 u-btn-1"
                  >
                    CLAIM
                  </a>
              ...
              <div
                className="u-align-left u-black u-container-style u-tab-pane u-tab-pane-2"
                id="tab-0da5"
                role="tabpanel"
              ...
              >
                <div className="u-container-layout u-container-layout-2">
                  ...
                  <h5 className="u-text u-text-default u-text-7">
                    <b>
                      ATTACK&nbsp; &nbsp;:&nbsp; &nbsp;
                      <span style={{ fontWeight: 400 }}>12</span>
                    </b>
                  </h5>
                  <a className="u-border-none u-btn u-btn-round u-button-style u-hover-palette-4-light-2 u-palette-4-base u-radius-50 u-btn-2">
                    MINT
                  </a>
                  <h5 className="u-text u-text-default u-text-8">
                    <b>
                      Health : <span style={{ fontWeight: 400 }}>30</span>
                    </b>
                  </h5>
                  ...
                  <img
                    ...
                    data-image-height={111}
                  />
                  <h5 className="u-text u-text-default u-text-9">
                    <b>STORM TROOPER</b>
                  </h5>
                  <h5 className="u-text u-text-default u-text-10">
                    <b>Owned&nbsp; &nbsp;:&nbsp; &nbsp;200 units</b>
                  </h5>
                  <h5 className="u-text u-text-default u-text-11">
                    <b>
                      ATTACK&nbsp; &nbsp;:&nbsp; &nbsp;
                      <span style={{ fontWeight: 400 }}>25</span>
                    </b>
                  </h5>
                  <a className="u-border-none u-btn u-btn-round u-button-style u-hover-palette-4-light-2 u-palette-4-base u-radius-50 u-btn-3">
                    MINT
                  </a>
                  <h5 className="u-text u-text-default u-text-12">
                    <b>
                      Health&nbsp; &nbsp;:&nbsp; &nbsp;7
              ...
              <div
                className="u-align-left u-black u-container-style u-tab-pane u-tab-pane-3"
                id="tab-2917"
                role="tabpanel"
                aria-labelledby="link-tab-2917"
              >
                <div className="u-container-layout u-container-layout-3">
                  <a className="u-btn u-btn-round u-button-style u-hover-palette-4-light-2 u-palette-4-base u-radius-50 u-btn-4">
                    {" "}
                    WON [Against @amature]&nbsp; &nbsp;:&nbsp; &nbsp;+100,000
                    FDH
                  </a>
                  <a className="u-border-none u-btn u-btn-round u-button-style u-hover-palette-2-light-2 u-palette-2-base u-radius-50 u-btn-5">
                    LOST [AGAINST @ALPHAKINGDOM]&nbsp; :&nbsp; - 75,000 FDH
                  </a>
                  <a className="u-border-none u-btn u-btn-round u-button-style u-hover-palette-4-light-2 u-palette-4-base u-radius-50 u-btn-6">
                    {" "}
                    WON [Against @DELTAKINGDOM]&nbsp; &nbsp;:&nbsp;
                    &nbsp;+10,000 FDH
                  </a>
                  <a className="u-border-none u-btn u-btn-round u-button-style u-hover-palette-4-light-2 u-palette-4-base u-radius-50 u-btn-7">
                    {" "}
                    WON [Against @LAZYLORD]&nbsp; &nbsp;:&nbsp; &nbsp;+100,000
                    FDH
                  </a>
                  <a className="u-border-none u-btn u-btn-round u-button-style u-hover-palette-4-base u-radius-50 u-white u-btn-8">
                    DRAW [Against @aLAMAKINGDOM]&nbsp; &nbsp;:&nbsp; &nbsp;+0
                    FDH
                  </a>
                </div>
              </div>
              <div
                className="u-align-left u-black u-container-style u-tab-pane u-tab-pane-4"
                id="link-tab-6e5a"
                role="tabpanel"
                aria-labelledby="tab-6e5a"
              >
                <div className="u-container-layout u-container-layout-4">
                  <a className="u-border-none u-btn u-btn-round u-button-style u-custom-color-2 u-hover-palette-4-light-2 u-radius-50 u-btn-9">
                    HARVESTED&nbsp; &nbsp;:&nbsp; &nbsp;+50,000 FDH
                  </a>
                  <a className="u-border-none u-btn u-btn-round u-button-style u-hover-palette-1-light-2 u-palette-1-base u-radius-50 u-btn-10">
                    UPGRADE TOWN (LEVEL 30)&nbsp; :&nbsp; - 10,000,000 FDH
                  </a>
                  <a className="u-border-none u-btn u-btn-round u-button-style u-hover-palette-3-light-2 u-palette-3-base u-radius-50 u-btn-11">
                    mINTED 10 STROM TROPPER&nbsp; &nbsp;:&nbsp; &nbsp;-100,000
                    FDH
                  </a>
                  <a className="u-border-none u-btn u-btn-round u-button-style u-hover-palette-3-light-2 u-palette-3-base u-radius-50 u-btn-12">
                    MINTED 10 LITTLE PENGUIN&nbsp; &nbsp;:&nbsp; &nbsp;-50,000
                    FDH
                  </a>
                  <a className="u-border-none u-btn u-btn-round u-button-style u-hover-palette-4-light-2 u-palette-4-base u-radius-50 u-btn-13">
                    WON [Against @amature]&nbsp; &nbsp;:&nbsp; &nbsp;+100,000
                    FDH
                  </a>
                </div>
