...
const deploy: DeployFunction = async function (
  ...
  console.log("check master role has minter role:", await tokenCT.hasRole(await tokenCT.MINTER_ROLE(), master.address));
  ...
  console.log("check master role has admin role:", await kingdomCT.hasRole(await kingdomCT.ADMIN_ROLE(), master.address));
};
